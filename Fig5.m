...
figure,
  XX = categorical({'Control','EED-KO','KMT2D-KO'});
   XX = reordercats(XX,{'Control','EED-KO','KMT2D-KO'});
...
R0=1029.996;
  ...
  Psi=Hcomp(0,0);
   MU0=20;
 Hz=@(Z,MU,S,R)H(S,500,2,2)* Psi*H(Z,Z0,4,1.4)/Ym(MU,MU0,3);
...
PRRXdot=@(R,S,T,Z) 6.3422*Psi*H(R,R0,2,1.6)*H(S,250,4,0.5 )*H(1.0*T,10,4 ,4)-0.02*R;%
